...
PROJECT_ABS_PATH = path.dirname(__file__)
IMAGES = path.join(PROJECT_ABS_PATH, 'images')
IMAGES_DATABASE = path.join(PROJECT_ABS_PATH, 'app', 'database', 'images_database.db')
ML_MODELS = path.join(PROJECT_ABS_PATH, 'models')
